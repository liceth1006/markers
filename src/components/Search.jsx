...
function Search({setSearchTerm,setFilteredProducts,product,searchTerm}) {
  ...
  return (
    <div className="flex items-center my-14 border w-80 focus-within:border-indigo-500 transition duration-300 pr-3 gap-2 bg-white border-gray-500/30 h-[46px] rounded-[5px] overflow-hidden">
    <input
      type="text"
